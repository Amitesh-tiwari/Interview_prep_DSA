...
Now, to generate rth ticket you have to take an r-1 th 
ticket and create a new encoding by writing down the 
frequency followed by a digit.
for example Ticket#(r-1) = “1121A” (Two 1, One 2, One 1, 
One A) so Ticket#(r) = “2112111A”
Examples:
